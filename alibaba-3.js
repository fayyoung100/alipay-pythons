...
function qiangHongbao8() {
  ...
  var qiang1 = document.querySelector(
    "body > div > div > div:nth-child(3) > div > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div > div:nth-child(4) > div"
    );
  if (qiang1 != null) {
    qiang1.click();
  }
...
function qiangHongbao3() {
  ...
  var qiang3 = document.querySelector(
    "body > div > div > div:nth-child(3) > div > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div > div:nth-child(4) > div"
  );
  if (qiang3 != null) {
    qiang3.click();
  }
